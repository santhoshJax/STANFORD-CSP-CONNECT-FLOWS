...
export interface UploadJobDataValues {
  /**
   * Connection
   *
   */
 ...
 */
export const uploadJobData = {
  key: "uploadJobData",
  perform: async <TReturn>(values: UploadJobDataValues): Promise<TReturn> => {
    const context = requireContext();
    return (await context.components.salesforce.uploadJobData({
      ...values,
    })) as TReturn;
  },
  inputs: {
