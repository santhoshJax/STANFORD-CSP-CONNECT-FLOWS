...
export interface AbortBulkJobValues {
  /**
   * Connection
   *
   */
 ...
 */
export const abortBulkJob = {
  key: "abortBulkJob",
  perform: async <TReturn>(values: AbortBulkJobValues): Promise<TReturn> => {
    const context = requireContext();
    return (await context.components.salesforce.abortBulkJob({
      ...values,
    })) as TReturn;
  },
  inputs: {
