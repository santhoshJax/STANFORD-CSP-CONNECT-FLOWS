...
export interface DeleteBulkQueryJobValues {
  /**
   * Connection
   *
   */
 ...
 */
export const deleteBulkQueryJob = {
  key: "deleteBulkQueryJob",
  perform: async <TReturn>(
    values: DeleteBulkQueryJobValues
  ): Promise<TReturn> => {
    const context = requireContext();
    return (await context.components.salesforce.deleteBulkQueryJob({
      ...values,
    })) as TReturn;
  },
  inputs: {
